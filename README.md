...
-get [KIOSK permashare URL](https://github.com/netbymatt/ws4kp?tab=readme-ov-file#kiosk-mode) from [NetByMatt's WeatherStar4000 web port or selfhosted url](https://github.com/netbymatt/ws4kp)
